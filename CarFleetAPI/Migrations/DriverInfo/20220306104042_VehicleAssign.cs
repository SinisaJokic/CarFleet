    ...
    public partial class VehicleAssign : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleAssign", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VehicleAssign_Drivers_DriverId",
                        column: x => x.DriverId,
                        principalTable: "Drivers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VehicleAssign_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssign_DriverId",
                table: "VehicleAssign",
                column: "DriverId");

            migrationBuilder.CreateIndex(
                name: "IX_VehicleAssign_VehicleId",
                table: "VehicleAssign",
                column: "VehicleId");
        }
